...
while True:
    ...
    hour24_vector = clock_hand_vector(hour/24*2*np.pi+minute/720*2*np.pi+second/3600*2*np.pi, hour_hand_length)
    plt.arrow(center[0], center[1], hour24_vector[0], hour24_vector[1], head_length = 5, linewidth = hour_hand_width, color = 'yellow')
